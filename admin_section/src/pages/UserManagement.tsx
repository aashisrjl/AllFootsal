...
const UserManagement = () => {
  const users = [
    ...
    { id: 2, name: 'Jane Smith', email: 'jane@example.com', role: 'facility_owner', status: 'active', joinDate: '2024-01-10' },
    { id: 3, name: 'Mike Johnson', email: 'mike@example.com', role: 'user', status: 'inactive', joinDate: '2024-01-08' },
  ];
