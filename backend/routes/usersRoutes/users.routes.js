...
router.get('/users/:id', isBothAuthenticated, getUserById);
router.get('/users/profile', isUserAuthenticated, getProfile);
router.put('/users/profile', isUserAuthenticated, updateProfile);
router.put('/users/profile/image', isUserAuthenticated, upload.single('profileImage'), updateProfileImage);
router.delete('/users/profile/image', isUserAuthenticated, deleteProfileImage);
