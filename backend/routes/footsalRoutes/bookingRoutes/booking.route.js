...
router.patch(
  "/futsal/bookings/:bookingId/reject", // #swagger.tags = ['Futsal/Tenant/Bookings']
  isFutsalAuthenticated,
...
router.patch(
  "/futsal/:futsalId/bookings/:bookingId/reschedule", // #swagger.tags = ['Futsal/Tenant/Bookings']
  isUserAuthenticated,
  rescheduleBooking
);
