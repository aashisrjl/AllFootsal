...
module.exports = userRegister = async (req, res) => {
  ...
  const location = req.headers['x-forwarded-for'] || req.connection.remoteAddress || 'Unknown location';
  // Hash password
  const hashedPassword = password ? await bcrypt.hash(password, parseInt(USER_PASSWORD_SALT_ROUNDS)) : null;
