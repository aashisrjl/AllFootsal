        ...
        <div className="p-5 overflow-y-auto flex-1">
          <form id="pitch-form" onSubmit={handleSubmit} className="space-y-4">
            <div>
              ...
              <input required type="text" value={formData.name} onChange={e => setFormData({...formData, name: e.target.value})} className="w-full px-4 py-2.5 bg-app-input border border-app-border-subtle text-app-text rounded-lg focus:ring-2 focus:ring-emerald-500/50 outline-none" placeholder="e.g. Pitch A" />
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-bold text-app-muted mb-1.5 uppercase tracking-wide">Type</label>
                <input required type="text" value={formData.pitch_type} onChange={e => setFormData({...formData, pitch_type: e.target.value})} className="w-full px-4 py-2.5 bg-app-input border border-app-border-subtle text-app-text rounded-lg outline-none focus:ring-2 focus:ring-emerald-500/50" />
              </div>
              <div>
                <label className="block text-xs font-bold text-app-muted mb-1.5 uppercase tracking-wide">Price/Hour ($)</label>
                <input required type="number" step="0.01" value={formData.price_per_hour} onChange={e => setFormData({...formData, price_per_hour: e.target.value})} className="w-full px-4 py-2.5 bg-app-input border border-app-border-subtle text-app-text rounded-lg outline-none focus:ring-2 focus:ring-emerald-500/50" />
              </div>
            </div>
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="block text-xs font-bold text-app-muted mb-1.5 uppercase tracking-wide">Surface</label>
                <input required type="text" value={formData.surface_type} onChange={e => setFormData({...formData, surface_type: e.target.value})} className="w-full px-4 py-2.5 bg-app-input border border-app-border-subtle text-app-text rounded-lg outline-none focus:ring-2 focus:ring-emerald-500/50" />
              </div>
              <div>
                <label className="block text-xs font-bold text-app-muted mb-1.5 uppercase tracking-wide">Dimensions</label>
                <input required type="text" value={formData.dimensions} onChange={e => setFormData({...formData, dimensions: e.target.value})} className="w-full px-4 py-2.5 bg-app-input border border-app-border-subtle text-app-text rounded-lg outline-none focus:ring-2 focus:ring-emerald-500/50" />
              </div>
            </div>
            <div className="grid grid-cols-3 gap-4 pt-2">
              <label className="flex items-center space-x-2 cursor-pointer">
                ...
                <span className="text-sm font-medium text-app-text">Lighting</span>
              </label>
              <label className="flex items-center space-x-2 cursor-pointer">
                ...
                <span className="text-sm font-medium text-app-text">Indoor</span>
              </label>
              <label className="flex items-center space-x-2 cursor-pointer">
                ...
                <span className="text-sm font-medium text-app-text">Active</span>
              </label>
            </div>
          </form>
        </div>
        
        <div className="p-5 border-t border-app-border flex justify-end gap-3 bg-app-surface-solid">
