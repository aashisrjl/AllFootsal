...
const Contact: React.FC = () => {
  ...
  const contactDetails = [
    ...
    { icon: Mail, title: "Email Us", text: "info@allfutsal.com", color: "text-emerald-600 dark:text-emerald-400", bg: "bg-emerald-50 dark:bg-emerald-900/30" },
