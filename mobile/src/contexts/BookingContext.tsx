...
export const BookingProvider: React.FC<{ children: ReactNode }> = ({ children }) => {
  ...
  const createBooking = async (
    ...
    Alert.alert("Booking Created", "Your booking has been successfully created!");
  ...
  const cancelBooking = async (bookingId: string, userId: string): Promise<boolean> => {
    try {
      ...
      Alert.alert("Cancellation Failed", "There was an error cancelling your booking. Please try again.");
